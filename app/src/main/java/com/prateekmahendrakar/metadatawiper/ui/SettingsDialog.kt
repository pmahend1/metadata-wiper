    ...
    Dialog(onDismissRequest = onDismiss) {
        Card {
            Column(modifier = Modifier.padding(16.dp),
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    ...
                    Theme.entries.forEach { theme ->
                        Row(Modifier
                            ...
                            RadioButton(selected = (theme == tempTheme),
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    Text(stringResource(id = R.string.file_options),
                         style = MaterialTheme.typography.titleMedium,
                         modifier = Modifier.padding(bottom = 8.dp)
                    )
                    Row(modifier = Modifier.fillMaxWidth(),
                        ...
                        Text(stringResource(id = R.string.overwrite_original_file),
                             style = MaterialTheme.typography.bodyLarge)
                        Switch(checked = tempOverwrite,
                ...
                Row(modifier = Modifier
                        ...
                        .padding(vertical = 8.dp),
                    verticalAlignment = Alignment.CenterVertically) {
                    Icon(painter = painterResource(id = R.drawable.star_24px),
                         contentDescription = stringResource(id = R.string.rate_and_review))
                    Text(text = stringResource(id = R.string.rate_and_review),
                         style = MaterialTheme.typography.bodyLarge,
